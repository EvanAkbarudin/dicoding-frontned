  ...
  return (
    <div className="max-w-4xl mx-auto mb-20 px-10">
      <div className="relative bg-white dark:bg-[#12121a] border border-gray-200 dark:border-white/10 rounded-2xl p-8 shadow-sm dark:shadow-none overflow-hidden transition-colors duration-300">
        ...
        {/* Top gradient line */}
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#e8ff47]/60 dark:via-[#e8ff47]/40 to-transparent" />

        {/* Label */}
        <p className="text-xs font-semibold tracking-widest uppercase text-gray-500 dark:text-white/40 mb-4 font-sans transition-colors duration-300">
          Isi Pesan SMS
        </p>
        ...
        <textarea
          ...
          className="w-full bg-gray-50 dark:bg-[#1a1a26] border border-gray-200 dark:border-white/10 rounded-xl px-6 py-5
                     ...
                     placeholder-gray-400 dark:placeholder-white/40 outline-none resize-y min-h-[160px]
                     focus:border-[#e8ff47] dark:focus:border-[#e8ff47]/50 focus:ring-2 focus:ring-[#e8ff47]/30 dark:focus:ring-transparent transition-all duration-300"
        />
        ...
        <div className="flex items-center justify-between mt-4">
          <span className="text-xs text-gray-500 dark:text-white/40 font-sans transition-colors duration-300">
