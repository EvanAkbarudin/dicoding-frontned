  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 mb-20">
      ...
      <div data-aos="fade-up" className="relative bg-white dark:bg-[#12121a] shadow-sm dark:shadow-none border border-gray-200 dark:border-[#e8ff47]/20 rounded-2xl p-8 mb-16 overflow-hidden transition-colors duration-300">
        ...
        <h2 className="font-display font-bold text-slate-900 dark:text-[#e8ff47] text-xl mb-6 flex items-center gap-2 transition-colors duration-300">🎣 Apa itu Phishing?</h2>
        ...
        <div className="flex gap-8 items-start">
          ...
          {/* Illustration box */}
          <div
            className="w-44 h-36 shrink-0 rounded-xl bg-gray-50 dark:bg-[#1a1a3a] border border-gray-200 dark:border-white/10
      ...
      <div className="mb-16">
        <h2 className="font-display font-bold text-slate-900 dark:text-white text-xl text-center mb-8 transition-colors duration-300">Tanda-tanda Pesan Berbahaya</h2>
      ...
      <div className="mb-16">
        <h2 className="font-display font-bold text-slate-900 dark:text-white text-xl text-center mb-8 transition-colors duration-300">5 Langkah Melindungi Diri</h2>
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-white/50 font-sans font-light leading-relaxed transition-colors duration-300">{step.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* ── Section 4: FAQ ── */}
      <div>
        <h2 className="font-display font-bold text-slate-900 dark:text-white text-xl text-center mb-8 transition-colors duration-300">Pertanyaan yang Sering Diajukan</h2>
        ...
        <div className="flex flex-col gap-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              <p className="text-xs text-[#0a0a0f]/70 font-sans font-light leading-relaxed">{faq.a}</p>
            </div>
          ))}
        </div>
      </div>
