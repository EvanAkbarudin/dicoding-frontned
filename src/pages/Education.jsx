export default function Education() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 mb-12 sm:mb-20">
      {/* ── Page header ── */}
      <div className="text-center mb-12 sm:mb-16">
        ...
        <p className="text-sm sm:text-base text-slate-500 dark:text-white/50 font-sans font-light leading-relaxed max-w-sm mx-auto transition-colors duration-300">
          Pelajari cara melindungi diri Anda dari penipuan digital. Informasi sederhana untuk menjaga pesan dan data Anda tetap aman.
        </p>
      </div>
      ...
      <div data-aos="fade-up" className="relative bg-white dark:bg-[#12121a] shadow-sm dark:shadow-none border border-gray-200 dark:border-[#e8ff47]/20 rounded-2xl p-6 sm:p-8 mb-12 sm:mb-16 overflow-hidden transition-colors duration-300">
        ...
        <div className="flex flex-col md:flex-row gap-6 sm:gap-8 items-start">
          <div className="flex-1 space-y-4">
            <p className="text-sm sm:text-base text-slate-600 dark:text-white/70 font-sans font-light leading-relaxed transition-colors duration-300">
              Phishing adalah cara penipu mencoba mencuri informasi pribadi Anda (seperti kata sandi atau nomor rekening) dengan menyamar sebagai pihak yang terpercaya melalui pesan atau email.
            </p>
            <p className="text-sm sm:text-base text-slate-600 dark:text-white/70 font-sans font-light leading-relaxed transition-colors duration-300">
              Bayangkan mereka sedang memancing (fishing), dan pesan penipuan adalah umpan yang mereka gunakan. Jangan sampai Anda 'terpancing'!
            </p>
          </div>

          {/* Illustration box */}
          <div
            className="w-full md:w-44 h-32 md:h-36 shrink-0 rounded-xl bg-gray-50 dark:bg-[#1a1a3a] border border-gray-200 dark:border-white/10
                          flex items-center justify-center text-4xl sm:text-5xl transition-colors duration-300"
          >
            🛡️
          </div>
        </div>
      ...
      <div className="mb-12 sm:mb-16">
        <h2 className="font-display font-bold text-slate-900 dark:text-white text-lg sm:text-xl text-center mb-6 sm:mb-8 transition-colors duration-300">Tanda-tanda Pesan Berbahaya</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {warningSigns.map((sign, index) => (
            ...
            >
              ...
              <p className="text-xs text-[#0a0a0f]/70 font-sans leading-relaxed">{sign.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="mb-12 sm:mb-16">
        <h2 className="font-display font-bold text-slate-900 dark:text-white text-lg sm:text-xl text-center mb-6 sm:mb-8 transition-colors duration-300">5 Langkah Melindungi Diri</h2>
        ...
        <div data-aos="fade-up" className="bg-white dark:bg-[#0f1022] shadow-sm dark:shadow-none border border-gray-200 dark:border-white/10 rounded-2xl overflow-hidden transition-colors duration-300">
          {steps.map((step, i) => (
            <div
              key={step.title}
              className={`flex items-start gap-3 sm:gap-4 px-5 sm:px-7 py-4 sm:py-5 transition-colors duration-300
      ...
      {/* ── Section 4: FAQ ── */}
      <div>
        <h2 className="font-display font-bold text-slate-900 dark:text-white text-lg sm:text-xl text-center mb-6 sm:mb-8 transition-colors duration-300">Pertanyaan yang Sering Diajukan</h2>
