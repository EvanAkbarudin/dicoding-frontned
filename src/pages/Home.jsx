    ...
    <>
      ...
      <section className="relative max-w-7xl mx-auto px-10 pt-16 pb-20">
        ...
        <p data-aos="fade-up" data-aos-delay="200"
           className="text-base font-light text-slate-500 dark:text-white/50 leading-relaxed max-w-sm mb-14 font-sans transition-colors duration-300">
        ...
        <div data-aos="fade-up" data-aos-delay="300" className="flex gap-12">
          {[
            ...
            <div key={label}>
              <div className="font-display font-extrabold text-slate-900 dark:text-white transition-colors duration-300"
